 ...
 * {@link VotesListFragment.OnFragmentInteractionListener} interface
...
public class VotesListFragment extends Fragment {
    ...
    public void onButtonPressed(Vote vote) {
        if (mListener != null) {
            mListener.onFragmentInteraction(vote);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(Vote vote);
    }
}
